...
export default defineTheme({
   typography: {
      $schema: {
         ...
         tags: ["@studioInput design-token", "@studioInputTokenType color", "@studioIcon material-symbols:article"],
      },
      body: {
         color: {
      ...
      verticalMargin: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType size", "@studioIcon mingcute:line-height-line"],
         },
         sm: "16px",
         base: "24px",
      },
      letterSpacing: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType size", "@studioIcon mingcute:letter-spacing-line"],
         },
         tighter: "-0.04em",
         tight: "-0.02em",
         normal: "0em",
      ...
      fontSize: {
         $schema: {
            title: "Horizontal spacings between letters.",
            tags: ["@studioInput design-token", "@studioInputTokenType font-size", "@studioIcon mingcute:font-size-fill"],
         },
         xs: "12px",
         sm: "14px",
         base: "16px",
      ...
      fontWeight: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType font-size", "@studioIcon mingcute:bold-fill"],
         },
         thin: "100",
         extralight: "200",
         light: "300",
      ...
      lead: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType font-size", "@studioIcon material-symbols:height-rounded"],
         },
         1: ".025rem",
         2: ".5rem",
         3: ".75rem",
      ...
      font: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType font", "@studioIcon material-symbols:font-download-rounded"],
         },
      ...
      color: {
         $schema: {
            ...
            tags: ["@studioInput design-token", "@studioInputTokenType color", "@studioIcon ph:palette"],
         },
         white: "#ffffff",
         black: "#0E0D0D",
         primary: {
   ...
   prose: {
      $schema: {
         ...
         tags: ["@studioInput design-token", "@studioInputTokenType font-size", "@studioIcon lucide:component"],
      },
      p: {
